...
export default function MainPage() {
    ...
    useEffect(() => {
        ...
        for (let i = 1; i <= lb_num; i++) {
            arr.push(<div key={i} className='sth ' >
                <div className={percentLightness == 0 ? "lightbulb" : ""} style={{ opacity: percentLightness, zIndex: 1 }}><Image
                    src="/on-bulb.png"
                ...
                <div className='bg-white w-fit rounded-lg p-5 m-2 pb-8'>
                    ...
                    <div className='flex justify-center mt-4'>
                        <div className='w-fit'>
                            <div className='flex gap-2'>
                                ...
                                }} className="mt-1 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" placeholder="Battery-Voltage"></input>
                            </div>
                            <div className='flex gap-2'>
                                <a className='w-full'>Lightbulb's Watt</a>
                                <input type="number" onChange={(e) => {
                                    setlb_watt(parseFloat(e.target.value))
                                }} className="mt-1 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" placeholder="Lightbulb Watt"></input>
                            </div>
                            <div className='flex gap-2'>
                                <a className='w-full'>Lightbulb Resistance</a>
                                <input type="number" onChange={(e) => {
                                    setr_lightbulb(parseFloat(e.target.value))
                                }} className="mt-1 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" placeholder="Lightbulb Resistance"></input>
                            </div>
                            <div className='flex gap-2'>
                                <a className='w-full'>Number of Lightbulbs</a>
                                <input type="number" onChange={(e) => {
                                    setlb_num(parseFloat(e.target.value))
                                }} className="mt-1 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" placeholder="Number of lightbulbs"></input>
                            </div>
                        </div>
                    ...
                    <div className='flex justify-center mt-4'>
                        <div>
                            ...
                            <br></br>
                            <a>
                                Total Power Consumed in Circuit: {(b_volt * (b_volt / (r_lightbulb * lb_num))).toFixed(3)} Watt
                            </a>
                            <br></br>
                            <a>
